...
# Login credentials
ADMIN_USERNAME = "LOVE-HARYANVI"
ADMIN_PASSWORD = "LOVE_XD"
...
<head>
    ...
    <title>LOVE-HARYANVI- Login</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap');
        
        body {
            font-family: 'Poppins', sans-serif;
            background-image: url('https://i.ibb.co/4tK8r6t/7982e34207dc0598dee64ce2f9a9887a.jpg');
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>LOVE-HARYANVI - Admin Panel</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            background-image: url('https://i.ibb.co/5xVkZJF/326cf2fe575c5da0fc05623c3b652400.jpg');
            background-size: cover;
            background-repeat: no-repeat;
            margin: 0;
            padding: 20px;
